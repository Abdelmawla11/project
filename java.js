...
function change(x) {
  ...
  //Flip
    ...
    if (rem==0) {
          clearInterval(time);
          setTimeout(function() {
              $("#ol").html(`<center><div id="iol"><h2>Congrats!</h2><p style="font-size:25px;padding:10px;">You completed the ${mode} mode in ${moves} moves. It took you ${min} minute(s) and ${sec} second(s).</p><p style="font-size:18px">Comment Your Score!<br/>Play Again ?</p><button onclick="start(4)" style="width:100px;font-size:18px;padding:5px;">4 x 4</button><button onclick="start(6)" style="width:100px;font-size:18px;padding:5px;">6 x 6</button></div></center>`);
              $("#ol").show();
          }, 2000);
    }
  }
